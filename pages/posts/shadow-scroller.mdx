...
So far, I don't have a perfect solution for all of the use cases. Each of the above approach can work for a specific scenario but you have to becareful for edge cases.
